            ...
            <div class="col-md-8">
                <div class="card borde-0 shadow-lg my-3">
                    <div class="card-header bg-dark">
                        ...
                        <form action="{{ route('products.update',$product->id) }}" method="POST" multipart="" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                            <div class="card-body">
                                <div class="mb-2">
                            ...
                            <div class="mb-2">
                                    ...
                                    <textarea class="form-control" name="description" cols="30" rows="5" placeholder="Desciption">{{ old('description',$product->description) }}</textarea>
                            </div>
                            <div class="mb-2">
                                    <label for="" class="form-lable h6">Image</label>
                                    <input type="file" class="form-control form-control-lg" placeholder="price" name="image">
                                    @if($product->image !="")
                                  <img class="w-50 my-2" src="{{ asset('upload_image/products/'.$product->image)}}" alt="">
                                    @endif
                            </div>
                            <div class="d-grid">
